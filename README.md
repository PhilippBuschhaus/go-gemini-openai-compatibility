# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/PhilippBuschhaus/go-gemini-openai-compatibility.svg)](https://pkg.go.dev/github.com/PhilippBuschhaus/go-gemini-openai-compatibility)
[![Go Report Card](https://goreportcard.com/badge/github.com/PhilippBuschhaus/go-gemini-openai-compatibility)](https://goreportcard.com/report/github.com/PhilippBuschhaus/go-gemini-openai-compatibility)
...
```
go get github.com/PhilippBuschhaus/go-gemini-openai-compatibility
```
...
See also: https://pkg.go.dev/github.com/PhilippBuschhaus/go-gemini-openai-compatibility#ClientConfig
</details>
...
import (
	...
	"github.com/PhilippBuschhaus/go-gemini-openai-compatibility"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/PhilippBuschhaus/go-gemini-openai-compatibility/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/PhilippBuschhaus/go-gemini-openai-compatibility/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/PhilippBuschhaus/go-gemini-openai-compatibility/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/PhilippBuschhaus/go-gemini-openai-compatibility/graphs/contributors) and sponsors of this project:
