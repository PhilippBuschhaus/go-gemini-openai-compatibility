...
func (e *APIError) UnmarshalJSON(data []byte) (err error) {
	...
	if err != nil {
		...
		// refs: https://github.com/PhilippBuschhaus/go-gemini-openai-compatibility/issues/381
		var messages []string
	...
	// refs: https://github.com/PhilippBuschhaus/go-gemini-openai-compatibility/issues/343
